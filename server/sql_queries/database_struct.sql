...
CREATE TABLE attendence(rfid INT NOT NULL, sessionid INT, MACAdress VARCHAR(17) NOT NULL, time DATETIME NOT NULL, FOREIGN KEY(rfid) REFERENCES people(rfid));
...
CREATE TABLE devices (MACaddress VARCHAR(17), UNIQUE KEY(MACaddress));
...
INSERT INTO attendence (rfid, MACAdress, time)
VALUES 
  (1, 'AF:CC:90:AA:32:43', '2016-12-12 18:40:00'),
  (2, 'AF:CC:90:AA:32:43', '2016-12-12 18:20:15'),
  (2, '62:C6:3F:00:27:FD', '2016-12-19 17:20:15');
